...
MOVB_QA: list[tuple[str, str]] = [
    (
        "MOVB가 뭐야",
        "MOVB는 한 출발지에서 여러 목적지로 보내는 묶음퀵의 경로와 예상 요금을 비교하고 접수하는 포트폴리오용 서비스예요.",
    ),
    (
        "묶음퀵이 뭐야",
        "묶음퀵은 한 사람이 같은 출발지에서 2~5곳으로 보낼 물품을 하나의 경유 배송으로 접수하는 기능이에요. "
        "각각 보낼 때의 합계와 묶음 가격, 추천 배송 순서를 접수 전에 비교할 수 있어요.",
    ),
    (
        "묶음퀵 요금은 어떻게 계산해",
        "각 목적지를 따로 보낼 때의 견적 합계와 추천 순서대로 한 번에 경유하는 묶음 견적을 비교해요. "
    ...
    (
        "묶음퀵 주문은 어떻게 해",
        "묶음퀵 접수 화면에서 출발지와 목적지 2~5곳, 각 연락처와 물품 정보를 입력하세요. "
