...
MOVB_QA: list[tuple[str, str]] = [
    (
        "MOVB가 뭐야",
        "MOVB는 여러 보내는 사람에게 물품을 픽업해 여러 받는 사람에게 배송하는 묶음퀵의 경로와 예상 요금을 비교하고 접수하는 포트폴리오용 서비스예요.",
    ),
    (
        "묶음퀵이 뭐야",
        "묶음퀵은 보내는 사람 1~5명의 물품을 픽업해 받는 사람 2~5명에게 하나의 경유 배송으로 접수하는 기능이에요. "
    ...
    (
        "묶음퀵 주문은 어떻게 해",
        "묶음퀵 접수 화면에서 보내는 사람과 받는 사람을 + 버튼으로 추가하고, 주소·연락처와 물품 정보를 입력하세요. "
